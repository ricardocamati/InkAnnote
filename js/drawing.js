// js/drawing.js — Desenho sobre o PDF
export function getOverlayPoint(e) {
...
export function resizeDrawingOverlay() {
...
// Expõe globalmente
window.getOverlayPoint = getOverlayPoint;
window.resizeDrawingOverlay = resizeDrawingOverlay;
