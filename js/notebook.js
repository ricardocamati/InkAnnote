// js/notebook.js — Caderno
export function setNoteIndex(idx, focus = true) {
...
export function createNotePage(linkedPages = null) {
  if (linkedPages === null) {
...
export function maybeCreateDefaultPage() {
  if (notebookPages.length === 0) {
    createNotePage();
  } else {
    focusEditor();
...
// Expõe globalmente
window.setNoteIndex = setNoteIndex;
window.renderNotebook = renderNotebook;
window.createNotePage = createNotePage;
window.maybeCreateDefaultPage = maybeCreateDefaultPage;
